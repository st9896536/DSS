...
picture = io.imread('D:\\Intellegence\\lesson9\\testpicture2.jpg',as_grey=True)
picture = picture*255
resultpicture = io.imread('D:\\Intellegence\\lesson9\\testpicture2.jpg')
integral_area = cal_integral(picture)
for k in range(19,58,19):
    for i in range(768-k):
